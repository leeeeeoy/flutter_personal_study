...
class _$PersonTearOff {
  ...
  _Loading loading({required int statusCode}) {
    return _Loading(
      statusCode: statusCode,
    );
  }

  _Error error(String message, {required int statusCode}) {
    return _Error(
      message,
      statusCode: statusCode,
    );
...
abstract class _Person implements Person {
  factory _Person(
      ...
      required String name,
      required int age,
      required int statusCode}) = _$_Person;
...
class _$_Loading implements _Loading {
  _$_Loading({required this.statusCode});
...
abstract class _Loading implements Person {
  factory _Loading({required int statusCode}) = _$_Loading;
...
class _$_Error implements _Error {
  _$_Error(this.message, {required this.statusCode});
...
abstract class _Error implements Person {
  factory _Error(String message, {required int statusCode}) = _$_Error;
