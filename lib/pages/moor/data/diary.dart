...
import 'package:flutter_study/pages/moor/data/tag.dart';
...
// 코드 제너레이션은 dao 설정에 필요하다

@UseDao(tables: [Diary, Tag, DiaryWithTag])
class DiaryDao extends DatabaseAccessor<MyDatabase> with _$DiaryDaoMixin {
  DiaryDao(MyDatabase db) : super(db);
